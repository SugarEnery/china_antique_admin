<template>
    <div class="container messageboard">
        ...
        <el-table :data="tableData" v-loading="listLoading"  border stripe style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="product_name" label="产品名称" align="center" width="100">
            </el-table-column>

            <el-table-column prop="product_price" label="产品价格" align="center" width="100">
            </el-table-column>
