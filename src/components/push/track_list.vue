 <template>
     <div class="container messageboard">
         ...
         <el-table :data="tableData" v-loading="listLoading"  border stripe style="width: 100%" @selection-change="handleSelectionChange">
             ...
             <el-table-column prop="news_id" label="消息" align="center" width="100">
             </el-table-column>
             ...
             <el-table-column prop="update_time" label="更新日期" align="center" width="100">
             </el-table-column>
             <el-table-column prop="add_time" label="创建日期" :formatter="this.$common.add_time" width="150" sortable>
             </el-table-column>

             <el-table-column label="操作" fixed="right" min-width="230">
                 <template slot-scope="scope">
                     <a href="#" style="color: #00D1B2" @click="lookTrack(scope.row)"><el-button size="mini" >查看</el-button></a>
         ...
         <el-dialog  :title="formEditTitle" :visible.sync="dialogEdittVisible" width="700px" @close="closeDialog('formEdit')">
             <el-form :label-position="labelPosition" :label-width="labelWidth" :rules="rulesEdit" :disabled="formEditDisabled" :inline="true" ref="formEdit" :model="formEdit" class="demo-form-inline">
                 <el-form-item label="跟踪ID" prop="id">
                     <el-input v-model="formEdit.id" placeholder="id" ></el-input>
                 </el-form-item>
                 <el-form-item label="详情内容" prop="news_content">
                     <el-input v-model="formEdit.news_content" placeholder="课程标题"></el-input>
                 </el-form-item>
             </el-form>
 ...
 export default {
     ...
     methods: {
         ...
         onSearch(){
             ...
             console.log(this.personInfo.id)
             let news_id = this.personInfo.id;//id
             var _this = this;
             apis.msgApi.trackList(news_id)
             .then((data)=>{
               console.log(data)
         ...
         // 查看跟踪列表
         lookTrack(row){
           this.$router.push({ name: 'look_track', query:row})
         },
