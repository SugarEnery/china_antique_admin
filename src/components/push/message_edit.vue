        ...
        <div class="container form02">
            <el-form :label-position="labelPosition" :rules="rules" ref="form02" :label-width="labelWidth" :inline="false" :model="form2" class="demo-form-inline">
                <el-form-item label="消息id" prop="id">
                    <el-input v-model="form2.id" placeholder="消息id" disabled=""></el-input>
                </el-form-item>
                <el-form-item label="研报链接" prop="shares_report_url">
                    <el-input v-model="form2.shares_report_url" placeholder="研报链接"></el-input>
                </el-form-item>
                <el-form-item label="标题" prop="title">
                    <el-input v-model="form2.title" placeholder="标题">{{personInfo}}</el-input>
                </el-form-item>
