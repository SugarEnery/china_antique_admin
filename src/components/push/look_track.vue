 <template>
     <div class="container messageboard">
         ...
         <el-table :data="tableData" v-loading="listLoading"  border stripe style="width: 100%" @selection-change="handleSelectionChange">
             ...
             <el-table-column prop="add_time" label="创建日期" :formatter="this.$common.add_time" width="200" sortable>
             </el-table-column>
 ...
 export default {
     ...
     methods: {
         ...
         onSearch(){
             ...
             this.formSearch.track_id = this.personInfo.id;//id
             let params = Object.assign({}, this.formSearch,this.pageInfo);

             var _this = this;
             apis.msgApi.trackDetail(params)
             .then((data)=>{
               console.log(data)
