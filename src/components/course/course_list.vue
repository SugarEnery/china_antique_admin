<template>
    <div class="container messageboard">
        ...
        <el-table :data="tableData" v-loading="listLoading"  border stripe style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="class_picture" label="封面图" align="center" width="150">
            </el-table-column>
            <el-table-column prop="class_length" label="视频时长" align="center" width="50">
            </el-table-column>
            <el-table-column prop="class_video_type" label="视频类型" align="center" width="100">
            </el-table-column>
            <el-table-column prop="click_count" label="点击数" width="50" align="center">
                 <template slot-scope="scope">
                    <a href="javacript:;" style="color: #00D1B2" @click="clickList(scope.row)">{{ scope.row.class_id}}</a>
                </template>
            </el-table-column>
            <el-table-column prop="give_count" label="点赞数" width="50" align="center">
                 <template slot-scope="scope">
                    <a href="javacript:;" style="color: #00D1B2" @click="giveList(scope.row)">{{ scope.row.class_id}}</a>
                </template>
            </el-table-column>
            <el-table-column prop="comment_count" label="评论数" width="50" align="center">
                 <template slot-scope="scope">
                    <a href="javacript:;" style="color: #00D1B2" @click="commentList(scope.row)">{{ scope.row.class_id}}</a>
                </template>
            </el-table-column>
            ...
            <el-form :label-position="labelPosition" :label-width="labelWidth" :rules="rulesEdit" :disabled="formEditDisabled" :inline="true" ref="formEdit" :model="formEdit" class="demo-form-inline">
                ...
                <el-form-item label="封面图" prop="class_picture">
                 ...
                 <el-form-item label="视频时长" prop="class_length">
                    <el-input  v-model="formEdit.class_length" placeholder="视频时长"></el-input>
                </el-form-item>

                <el-form-item label="视频类型" prop="class_video_type">
                    <el-input v-model="formEdit.class_video_type" placeholder="视频类型"></el-input>
                    <p>注：1网页2视频3第三方</p>
                </el-form-item>
                <el-form-item label="微信平台" prop="wx_id">
                    <el-input v-model="formEdit.wx_id" placeholder="微信平台" ></el-input>
                </el-form-item>
                <el-form-item label="点赞数" prop="class_give">
                    <el-input  v-model="formEdit.class_give" placeholder="点赞数"></el-input>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        // 点赞数列表
        giveList(row){
            this.$common.OpenNewPage(this,'give_list',row);
        },
        // 评论列表
        commentList(row){
            this.$common.OpenNewPage(this,'comment_list',row);
        }
