<template>
    <div class="container messageboard">
        ...
        <el-table :data="tableData" v-loading="listLoading"  border stripe style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="admin_name" label="账号名称" align="center" width="100">
            </el-table-column>
            <el-table-column prop="admin_password" label="账号密码" align="center" width="350">
            </el-table-column>
            <el-table-column prop="admin_ctime" label="创建时间" align="center" width="100">
            </el-table-column>
            <el-table-column prop="admin_fid" label="父id" align="center" width="100">
            </el-table-column>
        ...
        <el-dialog  :title="formEditTitle" :visible.sync="dialogEdittVisible" width="700px" @close="closeDialog('formEdit')">
            <el-form :label-position="labelPosition" :label-width="labelWidth" :rules="rulesEdit" :disabled="formEditDisabled" :inline="true" ref="formEdit" :model="formEdit" class="demo-form-inline">
                 <el-form-item label="账号id" prop="admin_id">
                    <el-input v-model="formEdit.admin_id" placeholder="id" ></el-input>
                </el-form-item>
                <el-form-item label="账号名称" prop="admin_name">
                    <el-input v-model="formEdit.admin_name" placeholder="部门名字"></el-input>
                </el-form-item>
            </el-form>
...
export default {
    ...
    methods: {
        ...
        onSearch(){
            ...
            var _this = this;
            apis.msgApi.directorList(param)
            .then((data)=>{
              console.log(data);
