<template>
    <div class="container messageboard">
        ...
        <el-table :data="tableData" v-loading="listLoading"  border stripe style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="admin_id" label="账号id" width="100" align="center" sortable>
                 <template slot-scope="scope">
                    <a href="javacript:;" style="color: #00D1B2" @click="openDetail(scope.row)">{{ scope.row.admin_id}}</a>
                </template>
            </el-table-column>
            <el-table-column prop="admin_name" label="账号名称" align="center" width="150">
            </el-table-column>
            <el-table-column prop="admin_status" label="账号状态" align="center" width="100">
            </el-table-column>

            <el-table-column label="操作" fixed="right" min-width="230">
                <template slot-scope="scope">
                    <!-- <el-button size="mini" @click="handleEdit(scope.$index, scope.row)">编辑</el-button> -->
                    <a href="#" style="color: #00D1B2" @click="accountEdit(scope.row)"><el-button size="mini" >修改</el-button></a>
        ...
        <el-dialog  :title="formEditTitle" :visible.sync="dialogEdittVisible" width="700px" @close="closeDialog('formEdit')">
            <el-form :label-position="labelPosition" :label-width="labelWidth" :rules="rulesEdit" :disabled="formEditDisabled" :inline="true" ref="formEdit" :model="formEdit" class="demo-form-inline">
                <el-form-item label="账号id" prop="admin_id">
                    <el-input v-model="formEdit.admin_id" placeholder="账号id" disabled=""></el-input>
                </el-form-item>
                <el-form-item label="登录账号" prop="admin_name">
                    <el-input v-model="formEdit.admin_name" placeholder="账号名称"></el-input>
                </el-form-item>
                <el-form-item label="姓名" prop="admin_names">
                    <el-input v-model="formEdit.admin_names" placeholder="姓名"></el-input>
                </el-form-item>
                ...
                <el-form-item label="密码" prop="admin_password">
                    <el-input v-model="formEdit.admin_password" placeholder="密码"></el-input>
                </el-form-item>
                <el-form-item label="所属部门" prop="depart_id">
                  <el-select v-model="formEdit.depart_id"  placeholder="请选择部门" >
                      <el-option
    ...
    methods: {
              ...
              if(data&&data.data){
                  var json=data;
                   if(json&&json.status == 200){
                      ...
                      this.formEdit.admin_password = data.data;
                      return;
                  }
              }
      ...
      selectRoleList() {//初始化下拉框动态数据
        ...
        handleDelete(index, rowData) {
            ...
            .then(() => {
              apis.msgApi.accountDelete({admin_id:admin_id})
              .then((data)=>{
                  if( data.data.error_code == 1000){
        ...
        handleEdit(index, rowData) {
            ...
            .then((data)=>{
              ...
              this.formEdit.admin_name = data.data.admin_name;
              this.formEdit.admin_names = data.data.admin_names;
              this.formEdit.depart_id = data.data.depart_id;
            })
            .catch((err)=>{
                this.listLoading=false;
                this.$message({message: '查询异常，请重试',type: "error"});
         ...
         */
        openDetail(row){
            this.$common.accountDetail(this,'detail',row);
        },
        accountEdit(row){
            this.$router.push({ name: 'account_edit', query:row})
        }
