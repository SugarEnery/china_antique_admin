<template>
    <div class="container messageboard">
        ...
        <el-table :data="tableData" v-loading="listLoading"  border stripe style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="class_id" label="id" width="100" align="center" sortable>
                 <template slot-scope="scope">
                    <a href="javacript:;" style="color: #00D1B2" @click="openDetail(scope.row)">{{ scope.row.class_id}}</a>
                </template>
            </el-table-column>
            <el-table-column prop="class_title" label="class_title" align="center" width="100">
            </el-table-column>

            <el-table-column prop="class_url" label="class_url" align="center" width="100">
            </el-table-column>
            <el-table-column prop="class_type" label="class_type" align="center" width="100">
            </el-table-column>
            <el-table-column prop="class_picture" label="class_picture" align="center" width="100">
            </el-table-column>
            <el-table-column prop="class_length" label="class_length" align="center" width="100">
            </el-table-column>
            <el-table-column prop="class_video_type" label="class_video_type" align="center" width="100">
            </el-table-column>
            <!-- <el-table-column prop="wx_id" label="wx_id" align="center" width="50">
            </el-table-column> -->
            <el-table-column prop="class_desc" label="class_desc" align="center" width="50">
            </el-table-column>
            <el-table-column prop="give_count" label="give_count" align="center" width="50">
            </el-table-column>
            <el-table-column prop="click_count" label="click_count" align="center" width="50">
            </el-table-column>
            <el-table-column prop="comment_count" label="comment_count" align="center" width="50">
            </el-table-column>
        ...
        <el-dialog  :title="formEditTitle" :visible.sync="dialogEdittVisible" width="700px" @close="closeDialog('formEdit')">
            <el-form :label-position="labelPosition" :label-width="labelWidth" :rules="rulesEdit" :disabled="formEditDisabled" :inline="true" ref="formEdit" :model="formEdit" class="demo-form-inline">
                <el-form-item label="id" prop="class_id">
                    <el-input v-model="formEdit.class_id" placeholder="姓名" ></el-input>
                </el-form-item>
                <el-form-item label="课程标题" prop="class_title">
                    <el-input v-model="formEdit.class_title" placeholder="地址"></el-input>
                </el-form-item>

                 <el-form-item label="class_url" prop="class_url">
                    <el-input  v-model="formEdit.class_url" placeholder="年龄"></el-input>
                </el-form-item>

                <el-form-item label="class_addtime" prop="class_addtime">
                    <el-input v-model="formEdit.class_addtime" placeholder="QQ号"></el-input>
                </el-form-item>
                <el-form-item label="课程类型" prop="class_type">
                    <el-input v-model="formEdit.class_type" placeholder="姓名" ></el-input>
                </el-form-item>
                <el-form-item label="课程图片" prop="class_picture">
                    <el-input v-model="formEdit.class_picture" placeholder="地址"></el-input>
                </el-form-item>

                 <el-form-item label="status" prop="class_length">
                    <el-input  v-model="formEdit.class_length" placeholder="年龄"></el-input>
                </el-form-item>

                <el-form-item label="class_video_type" prop="class_video_type">
                    <el-input v-model="formEdit.class_video_type" placeholder="QQ号"></el-input>
                </el-form-item>
                <el-form-item label="wx_id" prop="wx_id">
                    <el-input v-model="formEdit.wx_id" placeholder="姓名" ></el-input>
                </el-form-item>
                <el-form-item label="class_desc" prop="class_desc">
                    <el-input v-model="formEdit.class_desc" placeholder="地址"></el-input>
                </el-form-item>
                <el-form-item label="give_count" prop="give_count">
                    <el-input  v-model="formEdit.give_count" placeholder="年龄"></el-input>
                </el-form-item>
                <el-form-item label="click_count" prop="click_count">
                    <el-input  v-model="formEdit.click_count" placeholder="年龄"></el-input>
                </el-form-item>
                <el-form-item label="comment_count" prop="comment_count">
                    <el-input  v-model="formEdit.comment_count" placeholder="年龄"></el-input>
                </el-form-item>
                <el-form-item label="class_addtime" prop="class_addtime">
                    <el-input v-model="formEdit.class_addtime" placeholder="class_addtime"></el-input>
                </el-form-item>
            </el-form>
