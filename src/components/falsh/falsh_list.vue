<template>
    <div class="container messageboard">
        ...
        <el-table :data="tableData" v-loading="listLoading"  border stripe style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="kx_id" label="快讯id" width="100" align="center" sortable>
                 <template slot-scope="scope">
                    <a href="javacript:;" style="color: #00D1B2" @click="openDetail(scope.row)">{{ scope.row.kx_id}}</a>
                </template>
            </el-table-column>
            <el-table-column prop="kx_title" label="标题" align="center" width="100">
            </el-table-column>
            <el-table-column prop="kx_addtime" label="创建日期" :formatter="this.$common.kx_addtime" width="150" sortable>
            </el-table-column>
