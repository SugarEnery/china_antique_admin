<template>
    <div class="container messageboard">
        ...
        <el-table :data="tableData" v-loading="listLoading"  border stripe style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="add_time" label="点击时间" align="center" >
            </el-table-column>
            <el-table-column prop="share_title" label="标题" align="center" >
            </el-table-column>
            <el-table-column prop="shares_status" label="状态" align="center" >
            </el-table-column>
            <el-table-column prop="shares_addtime" label="添加时间 " align="center" >
            </el-table-column>
        </el-table>
