<template>
    <div class="container messageboard">
        ...
        <!-- 表格---start -->
        <!-- {{personInfo}} -->
        <el-table :data="tableData" class="tableBox" v-loading="listLoading"  border stripe style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="title" label="标题" align="center" >
                ...
                <el-table-column prop="mt_name" label="名称" align="center" >
                </el-table-column>
                <el-table-column prop="product_name" label="产品名称" align="center" >
                </el-table-column>
                <el-table-column prop="is_shares" label="分享" align="center" >
                </el-table-column>
                <el-table-column prop="new_content" label="详情 " align="center" >
                </el-table-column>
...
export default {
    ...
    methods: {
        ...
        onSearch(){
            ...
            // var id = this.personInfo.id;
            this.formSearch.id = this.personInfo.id;
            // let param = Object.assign({}, this.formSearch,this.pageInfo,id);
            let id = this.personInfo.id;
            var _this = this;
            apis.msgApi.pushNum(id)
            .then((data)=>{
              console.log(data.data)
                ...
                if (data && data.data) {
                        var json = data.data;
                        if ( data.status == 200) {
                          this.pageInfo.pageTotal=data.data.length;
        ...
        holdList(row){
            this.$common.OpenNewPage(this,'stockList',row);
        }
    }
};
</script>
